...
function Navbar() {
  ...
  return (
    <nav
      ...
      className={`flex flex-row items-center justify-between font-medium text-body/medium ease-in-out duration-300 lg:py-6 lg:px-5 xs:p-4 fixed z-[100] top-0 left-0 right-0 ${
        navColor ? "nav-scroll" : ""
      }`}
    >
      <a
